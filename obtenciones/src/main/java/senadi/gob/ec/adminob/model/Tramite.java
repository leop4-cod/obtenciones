...
public class Tramite implements Serializable {
    ...
    /** Numeración interna de la empresa, ej: INT-2025-001. Debe ser único si se ingresa. */
    @Column(name = "numeracion_interna", length = 50)
    ...
    public String getNumeracionInterna() { return numeracionInterna; }
    public void setNumeracionInterna(String numeracionInterna) {
        this.numeracionInterna = (numeracionInterna != null && numeracionInterna.trim().isEmpty())
                ? null : (numeracionInterna != null ? numeracionInterna.trim() : null);
    }
